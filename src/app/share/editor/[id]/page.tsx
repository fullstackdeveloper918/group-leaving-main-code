    ...
    <div className="container">
      <div className=" md:flex block">
        ...
        <div className="md:w-1/2 w-full md:mt-0 mt-5  flex items-center justify-start flex-col">
          ...
          <div className="bg-white shadow-lg rounded-lg p-10 w-full max-w-lg flex flex-col gap-2 items-center">
            ...
            <Image
              src={
                cardData?.images?.[0]?.card_images?.[0]
                  ? `${process.env.NEXT_PUBLIC_API_URL}/${cardData.images[0].card_images[0]}`
                  : "https://gift.wegift.io/static/product_assets/AMZ-GB/AMZ-GB-card.png"
              }
              width={200}
              height={200}
      ...
      >
        ...
        <Paragraph>
          ...
          They will be able to add a message to the card without having to sign
          up for an account. You can also share the QR code if that is easier.
        </Paragraph>
