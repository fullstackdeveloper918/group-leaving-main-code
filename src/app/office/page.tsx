...
const OfficePage = () => (
  <div className="max-w-7xl mx-auto p-6 text-gray-800">
    ...
    <p className="mb-4">We are proud of our modern office space, which reflects our brand values and commitment to excellence. From collaborative meeting rooms to quiet zones for focused work, our office is designed to meet the diverse needs of our team.</p>
    <p className="mb-4">At Goodluckcards, we are always looking for talented individuals to join our team. If you are passionate about making a difference and want to be part of a dynamic and forward-thinking company, we invite you to explore career opportunities with us.</p>
    <p className="mb-4">Visit us to experience our vibrant office culture and see firsthand how we work together to create memorable moments for our users.</p>
  </div>
);
