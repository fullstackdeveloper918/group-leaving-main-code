...
const AboutPage = () => (
  <div className="max-w-7xl mx-auto p-6 text-gray-800">
    <h1 className="text-3xl font-bold mb-4">About Goodluckcards</h1>
    <p className="mb-4">Welcome to Goodluckcards, your trusted platform for creating, sharing, and celebrating special moments with personalized group cards. Our mission is to bring people together, no matter where they are, to express their heartfelt wishes and gratitude.</p>
    <p className="mb-4">Founded with the vision of making every occasion memorable, Goodluckcards offers a seamless experience for users to collaborate on group cards for birthdays, farewells, anniversaries, and more. We believe that every milestone deserves to be celebrated with warmth and creativity.</p>
