...
const HowToBlogPage = () => (
  <div className="max-w-7xl mx-auto p-6 text-gray-800">
    ...
    <p className="mb-4">Welcome to the How to - Blog section of Goodluckcards! Our blog is dedicated to providing practical tips, creative ideas, and expert advice to help you make the most of your group card experience.</p>
    <p className="mb-4">From step-by-step guides on creating personalized cards to inspiration for unique messages, our blog covers a wide range of topics to spark your creativity and enhance your celebrations.</p>
